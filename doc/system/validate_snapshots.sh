...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/CTXSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** CTX" "index designation"
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/CTXSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** CTX" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/CTXSYSTEM.md\`" "assembled primary output"
